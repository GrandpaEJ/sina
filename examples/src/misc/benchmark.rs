...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Benchmark 1: Simple shapes
    {
        ...
        for i in 0..1000 {
            ...
            surface
                .canvas()
                .draw_rect(Rect::new(x, y, 40.0, 40.0), &paint);
        }
    ...
    // Benchmark 2: Circles
    {
        ...
        for i in 0..500 {
            ...
            surface.canvas().draw_circle(Point::new(x, y), 10.0, &paint);
        }
    ...
    // Benchmark 3: Lines
    {
        ...
        paint.set_stroke(sina::StrokeStyle {
            width: 2.0,
            ..Default::default()
        });
        ...
        for i in 0..2000 {
            ...
            surface
                .canvas()
                .draw_line(Point::new(x1, y1), Point::new(x2, y2), &paint);
        }
