...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    draw_regular_polygon(&mut surface, Point::new(200.0, 200.0), 80.0, 5, Color::rgb(255, 100, 100));
    
    // Hexagon
    println!("Drawing hexagon...");
    draw_regular_polygon(&mut surface, Point::new(450.0, 200.0), 80.0, 6, Color::rgb(100, 255, 100));
    
    // Octagon
    println!("Drawing octagon...");
    draw_regular_polygon(&mut surface, Point::new(700.0, 200.0), 80.0, 8, Color::rgb(100, 100, 255));
    
    // Decagon
    println!("Drawing decagon...");
    draw_regular_polygon(&mut surface, Point::new(950.0, 200.0), 80.0, 10, Color::rgb(255, 255, 100));
    
    // 5-pointed star
    println!("Drawing 5-pointed star...");
    draw_star(&mut surface, Point::new(200.0, 500.0), 80.0, 40.0, 5, Color::rgb(255, 215, 0));
    
    // 6-pointed star
    println!("Drawing 6-pointed star...");
    draw_star(&mut surface, Point::new(450.0, 500.0), 80.0, 40.0, 6, Color::rgb(200, 150, 255));
    
    // 8-pointed star
    println!("Drawing 8-pointed star...");
    draw_star(&mut surface, Point::new(700.0, 500.0), 80.0, 40.0, 8, Color::rgb(100, 200, 255));
    
    // Triangle (3-sided polygon)
    println!("Drawing triangle...");
    draw_regular_polygon(&mut surface, Point::new(200.0, 750.0), 80.0, 3, Color::rgb(255, 150, 150));
...
fn draw_regular_polygon(surface: &mut CpuSurface, center: Point, radius: f32, sides: u32, color: Color) {
...
fn draw_star(surface: &mut CpuSurface, center: Point, outer_radius: f32, inner_radius: f32, points: u32, color: Color) {
    let mut path = Path::builder();
