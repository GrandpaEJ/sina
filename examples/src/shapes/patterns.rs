...
use sina::{Color, Paint, Point, Rect, Surface, CpuSurface, Path};
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    for row in 0..5 {
        for col in 0..10 {
            ...
            surface.canvas().draw_circle(Point::new(x, y), 21.0, &outline);
        }
    }
    
    surface.save_png("examples/output/shapes/patterns.png")?;
    println!("\n✅ Saved to examples/output/shapes/patterns.png");
